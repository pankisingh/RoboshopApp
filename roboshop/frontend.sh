...
sed -i -e '/catalogue s/localhost/catalogue.roboshop.internal/' '/cart s/localhost/cart.roboshop.internal/' -e '/user s/localhost/user.roboshop.internal/' /etc/nginx/default.d/roboshop.conf  &>>$LOG
STAT_CHECK $?
